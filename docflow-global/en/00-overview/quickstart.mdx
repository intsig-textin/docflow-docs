...
Please contact Intsig’s sales team to obtain your TextIn Account.
Use TextIn Account to login and get `x-ti-app-id` and `x-ti-secret-code` from [Textin console API Keys & Account](https://www.textin.ai/console/dashboard/setting).
