...
<Tip>
Docflow 采用[xParse](https://textin.ai/market/detail/pdf_to_markdown)作为核心文档解析服务，能够将 PDF、Word 以及常见图片格式的文档，精准转换为包含文本、表格、标题层级、公式、手写字符和图片信息的结构化数据，便于后续的自动化处理与分析。
