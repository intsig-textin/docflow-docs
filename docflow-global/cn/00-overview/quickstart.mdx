...
<Tip>
  ...
  但如果您没有在Web UI上使用过Docflow，建议您先在[Web页面](https://docflow.textin.ai/)上传文件直观体验一下Docflow的工作方式。
</Tip>
...
请先登录后前往 [TextIn工作台 - 账号与开发者信息](https://textin.ai/console/dashboard/setting) 获取您的`x-ti-app-id`和`x-ti-secret-code`。
