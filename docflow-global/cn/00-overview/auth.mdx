...
DocFlow使用[TextIn](https://textin.ai/)账号。

请在[TextIn](https://textin.ai/)上注册后，在 [TextIn首页-账户与充值-账号与开发者信息 ](https://textin.ai/console/dashboard/setting)页面获取 `x-ti-app-id` 和 `x-ti-secret-code`，用于请求认证。
